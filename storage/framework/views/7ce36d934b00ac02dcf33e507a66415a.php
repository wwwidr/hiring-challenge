...
<?php $__env->startSection('title', 'Weight Training'); ?>
...
<div class="space-y-6">
    ...
    <?php if(!isset($trainingData)): ?>
        <form method="POST" action="<?php echo e(route('training.generate')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <?php echo $__env->make('training.validation', [
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\marce\Documents\GitHub\hiring-challenge\resources\views/training/index.blade.php ENDPATH**/ ?>